...
var HarmonyContract = (function (_super) {
    __extends(HarmonyContract, _super);
    function HarmonyContract(abi, address, provider, options) {
        var _this = _super.call(this, abi, address, options, provider) || this;
        _this.wallet = provider;
        return _this;
    }
    return HarmonyContract;
}(contract_1.Contract));
exports.HarmonyContract = HarmonyContract;
var BaseContract = (function () {
    function BaseContract(address, abi, provider, options) {
    ...
    BaseContract.prototype.sanitizeAddress = function (address) {
        return address.toLowerCase();
    };
    BaseContract.prototype.estimateGas = function (method, args, options) {
        if (args === void 0) { args = []; }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _b.label = 2;
                    case 2: return [2, __assign(__assign({}, options), { gasLimit: gasLimit })];
                }
            });
        });
    };
    BaseContract.prototype.call = function (method, args, txOptions) {
        if (args === void 0) { args = []; }
        return __awaiter(this, void 0, void 0, function () {
            var options;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        options = _b.sent();
                        return [2, (_a = this._contract.methods)[method].apply(_a, args).call(options)];
                }
            });
        });
    };
    BaseContract.prototype.send = function (method, args, txOptions) {
        if (args === void 0) { args = []; }
        return __awaiter(this, void 0, void 0, function () {
    ...
    BaseContract.prototype.setSignerByPrivateKey = function (privateKey) {
    ...
    BaseContract.prototype.setSignerByMnemonic = function (mnemonic, index) {
    ...
    BaseContract.prototype.setSignerByKey = function (key) {
