...
export class EthBaseContract {
    ...
    getCallOptions(methodName, args) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return {
                gasLimit,
                maxFeePerGas: parseUnits(formatUnits((_a = fees.maxFeePerGas) !== null && _a !== void 0 ? _a : 0, 'gwei'), 'gwei'),
                maxPriorityFeePerGas: parseUnits(formatUnits((_b = fees.maxPriorityFeePerGas) !== null && _b !== void 0 ? _b : 0, 'gwei'), 'gwei'),
            };
        });
    }
